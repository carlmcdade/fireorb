<?php
/*
    Titles and Headers in image format. For best results use a pre made none dynamic background file  
*/


$font_file  = 'fonts/Comfortaa_Bold.ttf' ;
$font_file_b  = 'fonts/VeraBI.ttf' ;
$font_size  = 30 ;
$font_color = '#FFFFFF' ;
...
$image = @imageCreateFromPNG("http://www.hiveminds.co.uk/communityframework/themes/firered/top_background.png");
if(!$image || !$box)
{
...
ImageTTFText($image,$font_size,0,$box[0]+10,abs($box[5]-$box[3])-$box[1] + 42,$font_color,$font_file, $text) ;
ImageTTFText($image,10,0,$box[0]+10,abs($box[5]-$box[3])-$box[1] + 62,$font_color,$font_file_b,$text_b) ;
